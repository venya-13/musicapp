...
public class CheckAlreadySong extends AppCompatActivity {

    private Button stopButton, playButton, goBackButton, skipSong,addSongButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSongButton.setOnClickListener(v ->{
            Intent intent = new Intent(CheckAlreadySong.this, FinalActivity.class);
